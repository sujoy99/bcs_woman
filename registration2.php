                ...
                <div class="col-12">
                    <div class="card " style="width: 95%">
                        <div class="card-header ">
                            ...
                            <p class="section_part btn btn-link" id="section_1_label">Section 1 : Personal Information
                            </p>
                ...
                <div class="col-12">
                    <div class="card " style="width: 95%">
                        <div class="card-header ">
                            ...
                            <p class="section_part btn btn-link" id="section_2_label">Section 2 : My Picture Upload</p>
                ...
                <div class="col-12">
                    <div class="card " style="width: 95%">
                        <div class="card-header ">
                            ...
                            <p class="section_part btn btn-link" id="section_3_label">Section 3 : Address Information
                            </p>
                ...
                <div class="col-12">
                    <div class="card " style="width: 95%">
                        <div class="card-header ">
                            ...
                            <p class="section_part btn btn-link" id="section_4_label">Section 4 : Educational
                ...
                <div class="col-12">
                    <div class="card " style="width: 95%">
                        <div class="card-header ">
                            ...
                            <p class="section_part btn btn-link" id="section_5_label">Section 5 : Interest & Hobbies</p>
                ...
                <div class="col-12">
                    <div class="card " style="width: 95%">
                        <div class="card-header ">
                            ...
                            <p class="section_part btn btn-link" id="section_6_label">Section 6 : Proffesional Records
                            </p>
                ...
                <div class="col-12">
                    <div class="card " style="width: 95%">
                        <div class="card-header ">
                            ...
                            <p class="section_part btn btn-link" id="section_7_label">Section 7 : Proffesional
                                Membership</p>
                ...
                <div class="col-12">
                    <div class="card " style="width: 95%">
                        <div class="card-header ">
                            ...
                            <p class="section_part btn btn-link" id="section_8_label">Section 8 : Honors & Awards
                                Received</p>
                        ...
                        <div class="card-body" id="section_8_content">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Honors & Awards Received"
                                    name="honor" id="honor">
                            </div>
                            <!-- honor ends  -->
                ...
                <div class="col-12">
                    <div class="card " style="width: 95%">
                        <div class="card-header ">
                            ...
                            <p class="section_part btn btn-link" id="section_9_label">Section 9 : Publications &
                                Articles</p>
                        ...
                        <div class="card-body" id="section_9_content">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Publications & Articles"
                ...
                <div class="col-12">
                    <div class="card " style="width: 95%">
                        <div class="card-header ">
                            ...
                            <p class="section_part btn btn-link" id="section_10_label">Section 10 : My Signature Upload
                            </p>
